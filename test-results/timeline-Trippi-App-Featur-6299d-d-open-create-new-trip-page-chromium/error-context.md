...
- Name: timeline.spec.ts >> Trippi App Features >> should open create new trip page
- Location: tests/timeline.spec.ts:63:7
...
Call log:
  - waiting for getByRole('link', { name: 'Create Trip' })
