...
- Name: timeline.spec.ts >> Trippi App Features >> should load the main page with animations and profile
- Location: tests/timeline.spec.ts:4:7
...
Locator: getByText('Your Adventure')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Your Adventure')
